...
<body>
    ...
    <section class="back">
        ...
        <div class="row">
            <div class="col-sm-5 col-md-6">
                <div class="titulo">
                    <h1>Sime <span>Tech</span></h1>
                    <div class="descricao">
                        <p>Estamos empenhados em impulsionar o sucesso de seu negócio por meio de tecnologia de ponta e soluções personalizadas. Como uma empresa líder em desenvolvimento de software, combinamos expertise técnica com criatividade para criar produtos que superam expectativas.</p>
                        <p>sua parceira confiável em soluções de software inovadoras</p>
                        <p>Sime Technologia para o seu sucesso !</p>
                        <hr>
                    </div>
                </div>
                        ...
                        <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active" data-bs-interval="10000">
                                    <img src="images/web.jp" class="d-block w-100" alt="...">
    ...
    <div class="container">
        <div class="row">
            <div class="col-6 col-sm-3">.sime

            </div>

            <div class="col-6 col-sm-3">.csame
        ...
        <center>
            <div class="">
                <form action="forma.php" method="post">
                    ...
                    <input type="text" id="nome_completo" name="nome_completo" placeholder="Digite seu nome completo!" required><br><br>

                    <label for="email">Email</label><br>
                    <input type="text" id="email" name="email" placeholder="Digite seu email!" required><br><br>

                    <label for="mensagem">Mensagem</label><br>
                    <input type="text" id="mensagem" name="mensagem" placeholder="Deixar seu mensagem!" required><br><br>
